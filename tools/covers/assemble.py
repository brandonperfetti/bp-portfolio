...
GLOWS = {
    ...
    '33': [('rgba(3,105,161,0.30)', 1024, 530, 1400, 900),
           ('rgba(3,105,161,0.10)', 410, 899, 1000, 700)],
    # batch 7
    '21': [('rgba(67,56,202,0.30)', 1024, 599, 1400, 900),
           ('rgba(67,56,202,0.12)', 1679, 253, 1000, 700)],
    '32': [('rgba(217,119,6,0.26)', 1024, 576, 1400, 900),
           ('rgba(217,119,6,0.10)', 369, 300, 1000, 700)],
    '37': [('rgba(3,105,161,0.30)', 942, 553, 1400, 900),
           ('rgba(3,105,161,0.10)', 1720, 829, 1000, 700)],
    '38': [('rgba(3,105,161,0.30)', 1065, 576, 1400, 900),
           ('rgba(3,105,161,0.10)', 328, 876, 1000, 700)],
    '39': [('rgba(3,105,161,0.30)', 983, 599, 1400, 900),
           ('rgba(3,105,161,0.10)', 1679, 300, 1000, 700)],
}
