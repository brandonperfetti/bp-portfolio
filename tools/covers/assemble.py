...
GLOWS = {
    ...
    # batch 3 backfill
    '27': [('rgba(13,128,106,0.28)', 778, 553, 1400, 900),
           ('rgba(13,128,106,0.08)', 1638, 806, 1000, 700)],
    '45': [('rgba(13,128,106,0.28)', 1024, 553, 1400, 900),
           ('rgba(13,128,106,0.10)', 410, 288, 1000, 700)],
    '46': [('rgba(13,128,106,0.28)', 1065, 484, 1400, 900),
           ('rgba(13,128,106,0.10)', 1597, 922, 1000, 700)],
    '44': [('rgba(13,128,106,0.28)', 1024, 599, 1400, 900),
           ('rgba(13,128,106,0.10)', 451, 230, 1000, 700)],
    '13': [('rgba(67,56,202,0.30)', 1024, 576, 1400, 900),
           ('rgba(67,56,202,0.12)', 1638, 253, 1000, 700)],
    '43': [('rgba(3,105,161,0.30)', 1024, 530, 1400, 900),
           ('rgba(3,105,161,0.10)', 410, 899, 1000, 700)],
    '12': [('rgba(162,28,175,0.26)', 922, 461, 1400, 900),
           ('rgba(162,28,175,0.10)', 1597, 922, 1000, 700)],
    # batch 4
    '25': [('rgba(124,58,237,0.28)', 942, 553, 1400, 900),
           ('rgba(124,58,237,0.10)', 1679, 876, 1000, 700)],
    '28': [('rgba(124,58,237,0.28)', 1188, 576, 1400, 900),
           ('rgba(124,58,237,0.10)', 328, 346, 1000, 700)],
    '1': [('rgba(162,28,175,0.26)', 1270, 553, 1400, 900),
          ('rgba(162,28,175,0.10)', 328, 806, 1000, 700)],
    '23': [('rgba(3,105,161,0.30)', 1024, 530, 1400, 900),
           ('rgba(3,105,161,0.10)', 1638, 899, 1000, 700)],
    '15': [('rgba(15,118,110,0.30)', 1024, 622, 1400, 900),
           ('rgba(15,118,110,0.10)', 1679, 276, 1000, 700)],
    '6': [('rgba(3,105,161,0.30)', 942, 576, 1400, 900),
          ('rgba(3,105,161,0.10)', 1720, 346, 1000, 700)],
    '3': [('rgba(217,119,6,0.26)', 860, 645, 1400, 900),
          ('rgba(217,119,6,0.10)', 1638, 300, 1000, 700)],
    # batch 5
    '31': [('rgba(13,128,106,0.28)', 1024, 576, 1400, 900),
           ('rgba(13,128,106,0.10)', 1720, 300, 1000, 700)],
    '8': [('rgba(162,28,175,0.26)', 1024, 553, 1400, 900),
          ('rgba(162,28,175,0.10)', 369, 876, 1000, 700)],
    '4': [('rgba(217,119,6,0.26)', 1106, 576, 1400, 900),
          ('rgba(217,119,6,0.10)', 328, 323, 1000, 700)],
    '18': [('rgba(67,56,202,0.30)', 942, 576, 1400, 900),
           ('rgba(67,56,202,0.12)', 1679, 853, 1000, 700)],
    '7': [('rgba(3,105,161,0.30)', 983, 599, 1400, 900),
          ('rgba(3,105,161,0.10)', 1720, 253, 1000, 700)],
    '30': [('rgba(15,118,110,0.30)', 901, 553, 1400, 900),
           ('rgba(15,118,110,0.10)', 1679, 899, 1000, 700)],
    '24': [('rgba(3,105,161,0.30)', 819, 530, 1400, 900),
           ('rgba(3,105,161,0.10)', 1720, 760, 1000, 700)],
    # batch 6
    '47': [('rgba(13,128,106,0.28)', 1024, 553, 1400, 900),
           ('rgba(13,128,106,0.10)', 369, 853, 1000, 700)],
    '22': [('rgba(217,119,6,0.26)', 1024, 622, 1400, 900),
           ('rgba(217,119,6,0.10)', 1679, 276, 1000, 700)],
    '36': [('rgba(162,28,175,0.26)', 1024, 576, 1400, 900),
           ('rgba(162,28,175,0.10)', 1720, 853, 1000, 700)],
    '34': [('rgba(15,118,110,0.30)', 1065, 576, 1400, 900),
           ('rgba(15,118,110,0.10)', 328, 300, 1000, 700)],
    '11': [('rgba(3,105,161,0.30)', 901, 576, 1400, 900),
           ('rgba(3,105,161,0.10)', 1720, 346, 1000, 700)],
    '19': [('rgba(67,56,202,0.30)', 1024, 599, 1400, 900),
           ('rgba(67,56,202,0.12)', 369, 276, 1000, 700)],
    '33': [('rgba(3,105,161,0.30)', 1024, 530, 1400, 900),
           ('rgba(3,105,161,0.10)', 410, 899, 1000, 700)],
}
