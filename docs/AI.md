...
**The first ratchet landed 2026-09-09 (#122): 75/70 → 80/75.** Seven keyed
runs from the 2026-08-29 baseline onward measured global 78, 88, 88, 86, 88,
94, 91, and site-facts 75 then 83. The new floors sit about six points under
the _worst_ of those, not under the best — a floor is only useful if an
ordinary bad day stays green and a real regression does not. Two things eat
margin and are why it is six and not two: the pool changes when a block is
added (34 → 41 evals above), and one block can move a long way on its own —
