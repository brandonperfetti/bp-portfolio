...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_shader_hero_preset" AS ENUM('northern-lights-2', 'ribbon-flows-4', 'synthesis-14', 'drifting-lights-8', 'static-noise-4');
  ...
  CREATE TYPE "public"."enum_pages_hero_shader_preset" AS ENUM('northern-lights-2', 'ribbon-flows-4', 'synthesis-14', 'drifting-lights-8', 'static-noise-4');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_shader_hero_preset" AS ENUM('northern-lights-2', 'ribbon-flows-4', 'synthesis-14', 'drifting-lights-8', 'static-noise-4');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_shader_preset" AS ENUM('northern-lights-2', 'ribbon-flows-4', 'synthesis-14', 'drifting-lights-8', 'static-noise-4');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_access_visibility" AS ENUM('public', 'gated');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_access_visibility" AS ENUM('public', 'gated');
  ...
  CREATE TYPE "public"."enum_tech_stack_proficiency" AS ENUM('daily', 'proficient', 'familiar', 'exploring');
  ...
  CREATE TABLE "pages_blocks_shader_hero" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"preset" "enum_pages_blocks_shader_hero_preset" DEFAULT 'northern-lights-2',
  	"rich_text" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages" (
  	...
  	"hero_shader_preset" "enum_pages_hero_shader_preset" DEFAULT 'northern-lights-2',
  ...
  CREATE TABLE "_pages_v_blocks_shader_hero" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"preset" "enum__pages_v_blocks_shader_hero_preset" DEFAULT 'northern-lights-2',
  	"rich_text" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_hero_shader_preset" "enum__pages_v_version_hero_shader_preset" DEFAULT 'northern-lights-2',
  ...
  CREATE TABLE "posts" (
  	...
  	"meta_description" varchar,
  	"published_at" timestamp(3) with time zone,
  	"access_visibility" "enum_posts_access_visibility" DEFAULT 'public',
  	"access_required_plan" varchar,
  	"access_required_feature" varchar,
  	"slug" varchar,
  	"slug_lock" boolean DEFAULT true,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_meta_description" varchar,
  	"version_published_at" timestamp(3) with time zone,
  	"version_access_visibility" "enum__posts_v_version_access_visibility" DEFAULT 'public',
  	"version_access_required_plan" varchar,
  	"version_access_required_feature" varchar,
  	"version_slug" varchar,
  	"version_slug_lock" boolean DEFAULT true,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "tech_stack" (
  	...
  	"category" "enum_tech_stack_category" NOT NULL,
  	"icon" varchar,
  	"logo_id" integer,
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"tech_stack_find" boolean DEFAULT false,
  	"tech_stack_create" boolean DEFAULT false,
  	"tech_stack_update" boolean DEFAULT false,
  	"tech_stack_delete" boolean DEFAULT false,
  	"uses_find" boolean DEFAULT false,
  	"uses_create" boolean DEFAULT false,
  	"uses_update" boolean DEFAULT false,
  	"uses_delete" boolean DEFAULT false,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Brandon Perfetti' NOT NULL,
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"copyright_name" varchar DEFAULT 'Brandon Perfetti',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "identity_same_as" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"url" varchar NOT NULL
  ...
  CREATE TABLE "identity" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar DEFAULT 'Brandon Perfetti' NOT NULL,
  	"job_title" varchar DEFAULT 'Technical PM + Software Engineer',
  	"image_id" integer,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "tech_stack_id" integer;
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "uses_id" integer;
  ...
  ALTER TABLE "pages_blocks_shader_hero" ADD CONSTRAINT "pages_blocks_shader_hero_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_shader_hero" ADD CONSTRAINT "_pages_v_blocks_shader_hero_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "tech_stack" ADD CONSTRAINT "tech_stack_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "uses" ADD CONSTRAINT "uses_tech_id_tech_stack_id_fk" FOREIGN KEY ("tech_id") REFERENCES "public"."tech_stack"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "identity_same_as" ADD CONSTRAINT "identity_same_as_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."identity"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "identity" ADD CONSTRAINT "identity_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_shader_hero_order_idx" ON "pages_blocks_shader_hero" USING btree ("_order");
  CREATE INDEX "pages_blocks_shader_hero_parent_id_idx" ON "pages_blocks_shader_hero" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_shader_hero_path_idx" ON "pages_blocks_shader_hero" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_shader_hero_order_idx" ON "_pages_v_blocks_shader_hero" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_shader_hero_parent_id_idx" ON "_pages_v_blocks_shader_hero" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_shader_hero_path_idx" ON "_pages_v_blocks_shader_hero" USING btree ("_path");
  ...
  CREATE INDEX "tech_stack_logo_idx" ON "tech_stack" USING btree ("logo_id");
  ...
  CREATE INDEX "uses_tech_idx" ON "uses" USING btree ("tech_id");
  ...
  CREATE INDEX "identity_same_as_order_idx" ON "identity_same_as" USING btree ("_order");
  CREATE INDEX "identity_same_as_parent_id_idx" ON "identity_same_as" USING btree ("_parent_id");
  CREATE INDEX "identity_image_idx" ON "identity" USING btree ("image_id");
...
export async function down({
  ...
  ALTER TABLE "pages_blocks_shader_hero" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "_pages_v_blocks_shader_hero" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "uses" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "identity_same_as" DISABLE ROW LEVEL SECURITY;
  ...
  DROP TABLE "pages_blocks_shader_hero" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_shader_hero" CASCADE;
  ...
  DROP TABLE "identity_same_as" CASCADE;
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_uses_fk";
  ...
  DROP INDEX "payload_locked_documents_rels_uses_id_idx";
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "uses_id";
  ...
  DROP TYPE "public"."enum_pages_blocks_shader_hero_preset";
  DROP TYPE "public"."enum_pages_blocks_spacer_size";
  DROP TYPE "public"."enum_pages_hero_type";
  DROP TYPE "public"."enum_pages_hero_shader_preset";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_shader_hero_preset";
  DROP TYPE "public"."enum__pages_v_blocks_spacer_size";
  DROP TYPE "public"."enum__pages_v_version_hero_type";
  DROP TYPE "public"."enum__pages_v_version_hero_shader_preset";
  DROP TYPE "public"."enum__pages_v_version_status";
  DROP TYPE "public"."enum_posts_access_visibility";
  DROP TYPE "public"."enum_posts_status";
  DROP TYPE "public"."enum__posts_v_version_access_visibility";
